...
AWSSecretKey   = "YOUR_SECRETE_KEY!!!"
MACHINE_TYPE   = "m3.medium"
LOAD_GEN_AMI   = "ami-562d853e"
DATA_CEN_AMI   = "ami-ec14ba84"
...
def create_LoadGenerator():
    ...
    conn.create_tags(instance_id, {"Project": "2.2"}, dry_run=False)
...
def activate_LoadGenerator(load_dns, elb_dns):
    url = "http://" + load_dns + "/begin-phase-2?" +\
